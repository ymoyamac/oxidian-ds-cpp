...
namespace ox::linked_list {
    ...
    void fmt(linkedlist_t* list) {
        int index = 0;
        ox::simple_node::node_t* iter = ox::simple_node::init(0);
        iter = list->head;
        printf("$ ");
        while (iter) {
    ...
    void push_back(linkedlist_t* list, void* data) {
        ...
        ox::simple_node::node_t* new_node = ox::simple_node::init(data);
        /**
    ...
    void push_at(linkedlist_t* list, void* data, int at) {
        ...
        ox::simple_node::node_t* iter = ox::simple_node::init(0);
        ox::simple_node::node_t* temp = ox::simple_node::init(0);
        /**
    ...
    void* get(linkedlist_t* list, int index) {
        ...
        ox::simple_node::node_t* iter = list->head;
